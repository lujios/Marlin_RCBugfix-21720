...
#if ENABLED(PIDTEMP)
  //#define PID_EDIT_MENU           // Add PID editing to the "Advanced Settings" menu. (~700 bytes of PROGMEM)       //Lujmemory
  //#define PID_AUTOTUNE_MENU       // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of PROGMEM)   //Lujmemory
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    // Horizontal distance bridged by diagonal push rods when effector is centered.
    #define DELTA_RADIUS 100.95             // (mm) Get this value from G33 auto calibrate
  #endif

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 293.89             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.251, -0.172, 0.0 } // Get these values from G33 auto calibrate
  ...
  #define DELTA_TOWER_ANGLE_TRIM { -0.273,0.020, 0.253 } // Get these values from G33 auto calibrate
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 500, 200, 200 }		//Luj
 ...
 */
#define MULTIPLE_PROBING 2        //Lujprobing
...
//#define DISABLE_M503        // Saves ~2700 bytes of PROGMEM. Disable for release!    //Lujmemory
